...
import ecapp.models.order_models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.CharField(default=ecapp.models.order_models.custom_timestamp_id, editable=False, max_length=50, primary_key=True, serialize=False)),
